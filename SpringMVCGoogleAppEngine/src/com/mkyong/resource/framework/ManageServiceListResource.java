 ...
 * 
 */
public class ManageServiceListResource<T> extends ServerResource {

	public static final Logger LOG = Logger
			.getLogger(ManageServiceListResource.class.getName());
	...
	protected ManageServiceDAO<T> dao;

	protected Class<T> clazz;

	private BaseSerializer<T> serializer;

	public ManageServiceListResource(Class<T> clazz,
